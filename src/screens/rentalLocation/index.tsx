...
export function RentalLocation() {
  ...
  const { categoryId, categoryOptionID } = route.params;
  ...
  return (
    <ScrollView style={[external.fx_1, { backgroundColor: linearColorStyle }]} showsVerticalScrollIndicat={false}>
      ...
      <View style={[styles.recentView, { backgroundColor: linearColorStyle }]}>
        ...
        >
          {fieldLength >= 3 ? "Address Suggestion" : "Recent"}
        </Text>
        <View
          style={[
            styles.mapView,
        ...
        <View style={[external.mv_15]}>
          <Button title={translateData.done} onPress={gotoBook} />
        </View>
      </View>
      <Modal
        animationType="none"
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Button title={translateData.close} onPress={() => setModalVisible(false)} />
          </View>
        </View>
      </Modal>
    </ScrollView>
