...
const styles = StyleSheet.create({
  ...
  icon_image_style: { height: 20, width: 20 },
  vehicle_map_icon: { width: 40, height: 40, resizeMode: "contain" },
  needHelpText: { color: appColors.buttonBg, fontFamily: appFonts.medium, marginHorizontal: windowWidth(25), },
});
