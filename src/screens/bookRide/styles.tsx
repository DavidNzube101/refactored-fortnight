...
const styles = StyleSheet.create({
  ...
  borderPayment: {
    borderBottomWidth: windowHeight(0.5),
    borderStyle: 'dashed',
    marginHorizontal: windowWidth(15),
  },
  ...
  userIcon: { marginRight: windowWidth(10) },
  cardView: {
    justifyContent: "space-between",
  ...
  switchRiderView: { justifyContent: "space-between" },
  scrollViewStyle: { marginBottom: windowHeight(80) },
  selectPaymentView: {
    marginVertical: windowHeight(35),
  },
  loaderGIF: { width: windowHeight(28), height: windowHeight(28) },
  selectedOptionView: {
    justifyContent: "space-between",
  ...
  solidLine: { marginTop: windowHeight(10) }
