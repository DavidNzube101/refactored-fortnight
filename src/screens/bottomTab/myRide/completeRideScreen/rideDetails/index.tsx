...
export function RideDetails() {
  const { isDark, textRTLStyle, currPrice, currSymbol, viewRTLStyle } = useValues();
    ...
    <ImageBackground style={styles.imageBackground} source={detailImage}>
      ...
      <View style={styles.billSummaryContainer}>
        ...
        <View style={[external.mt_10]}>
          <DetailContainer value={[currSymbol, currPrice * 46]} title={translateData.rideFare} />
        </View>
        <View style={[external.mv_10]}>
          <DetailContainer value={[currSymbol, currPrice * 4]} title={translateData.totalAccessFee} />
        </View>
