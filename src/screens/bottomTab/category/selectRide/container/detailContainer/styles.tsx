...
const styles = StyleSheet.create({
  ...
  mainContainer: {
    borderTopLeftRadius: windowHeight(18),
    borderTopRightRadius: windowHeight(18),
  },
  container: {
    backgroundColor: appColors.lightGray,
  ...
  cardView: { marginHorizontal: windowWidth(5) },
  cardMainView: {
    justifyContent: "space-evenly",
    alignItems: "center", borderRadius: windowHeight(6), height: 45, width: "100%",
  },
  switchRiderView: {
    marginHorizontal: windowWidth(15),
    paddingVertical: windowHeight(15),
  },
  linearGradientView: { flex: 1, position: "absolute", bottom: 0 },
  listView:  { position: "absolute", top: windowHeight(38), zIndex: 2 },
